...
//                        break;
    ...
    public static String readDocFile (String docFilePath) throws IOException {
        FileInputStream fis = new FileInputStream(docFilePath);
        HWPFDocument doc = new HWPFDocument(fis);
        return new WordExtractor(doc).getText();
    }

    public static String readDocxFile (String docxFilePath) throws IOException {
        FileInputStream fistream = new FileInputStream(docxFilePath);
        XWPFDocument docX = new XWPFDocument(fistream);
